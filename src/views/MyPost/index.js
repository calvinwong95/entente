    ...
    <Dashboard>
      <Box sx={{ height: "100%" }}>
        ...
        >
          ...
          <Typography variant="h2">My Post</Typography>
        </Box>
        {/*Main Content */}
        <Box
          sx={{
        ...
        >
          ...
          >
            <Box>
              <Typography variant="h4">Card Colour</Typography>
              <TenDropdown disabled={isEdit ? false : true}>
                <MenuItem value={10}>Navy Blue</MenuItem>
                <MenuItem value={20}>Purple Delight</MenuItem>
                <MenuItem value={30}>Red Hot Chilli Peppers</MenuItem>
              </TenDropdown>
            </Box>

            <Box>
              <Typography variant="h4">Broadcast Message</Typography>
              <TenTextField
                placeholder="Insert Copywriting Here"
                rows={5}
                disabled={isEdit ? false : true}
              ></TenTextField>
            </Box>
            ...
            <Box>
              <Typography variant="h4">Post Status</Typography>
            </Box>
          </Box>
        </Box>
      </Box>
